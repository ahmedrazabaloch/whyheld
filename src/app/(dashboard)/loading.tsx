/**
 * Dashboard group loading UI.
 * Shown in the page content area while any dashboard page's server component
 * is resolving. The sidebar and shell are already rendered by layout.tsx.
 */
export default function DashboardGroupLoading() {
  return (
    <div className="animate-pulse space-y-6" aria-label="Loading…" aria-busy="true">
      ...
      {/* Content skeleton — three stat cards */}
        ...
        {[0, 1].map((i) => (
          ...
          >
            ...
            <div className="mt-3 space-y-2">
              ...
              <div className="h-3 w-3/4 rounded-full bg-brand-border/20" />
            </div>
