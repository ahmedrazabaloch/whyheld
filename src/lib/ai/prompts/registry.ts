...
registerPrompt({
  ...
  systemPrompt: [
    ...
    '   Never output string values, quoted numbers, or human-readable time labels like "Morning", "Evening", "Day 1", "Late afternoon", or "1".',
    "3. Output MUST validate against the expected schema exactly.",
  ].join("\n"),
